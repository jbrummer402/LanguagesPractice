...
const USER_MESSAGE_CLASS: &str = "max-w-md p-4 mb-5 rounded-1g self-end bg-blue-500 text-white";
const MODEL_MESSAGE_CLASS: &str = "max-w-d p-4 mb-5 rounded-1g self-start bg-gray-200 text-black";
